...
**作业设置** ：作业是提交到集群中的一个工作单元，一个作业可能包含一个或多个分布式计算任务，您需要为临时集群添加作业，并且对一个集群提交多达256个作业，作业运行结束后，集群自动释放。您可以通过“添加作业”超链接添加作业，详情请参考[作业创建指南](zuo_ye_chuang_jian_zhi_nan.md)，也可以对已添加的作业进行编辑和删除
